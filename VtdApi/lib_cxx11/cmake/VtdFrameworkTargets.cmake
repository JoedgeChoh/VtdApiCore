...
add_library(VtdCore SHARED IMPORTED)

set_target_properties(VtdCore PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "_GLIBCXX_USE_CXX11_ABI=\$<BOOL:ON>;\$<\$<CONFIG:Debug>:VTD_DEBUG>;\$<\$<PLATFORM_ID:Linux>:VTD_OS_LINUX>;\$<\$<PLATFORM_ID:Windows>:VTD_OS_WINDOWS>"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "TinyXML::Static;Boost::chrono;Boost::filesystem;Boost::thread"
)

# Create imported target VtdMath
add_library(VtdMath SHARED IMPORTED)
...
set_target_properties(VtdMath PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "VtdCore"
)

# Create imported target VtdNetwork
add_library(VtdNetwork SHARED IMPORTED)
...
add_library(VtdHdf5 SHARED IMPORTED)

set_target_properties(VtdHdf5 PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "HDF_ENABLED"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "VtdCore;VtdToolkit;VtdThreads;hdf5::hdf5-static;hdf5::hdf5_hl-static"
)

# Create imported target VtdCompression
add_library(VtdCompression SHARED IMPORTED)

set_target_properties(VtdCompression PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "_GLIBCXX_USE_CXX11_ABI=\$<BOOL:ON>;\$<\$<CONFIG:Debug>:VTD_DEBUG>"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Lz4::Lz4;ZLIB::ZLIB;VtdCore"
)

# Create imported target VtdEncryption
add_library(VtdEncryption SHARED IMPORTED)
