...
namespace RdbToHdf5Writer
{
    ...
    public:
        ...
        enum  RDB_CAMERA_HDF5 { RDB_CAMERA_HDF5_ID,
                                RDB_CAMERA_HDF5_WIDTH,
                                RDB_CAMERA_HDF5_HEIGHT,
                                RDB_CAMERA_HDF5_SPARE0,
                                RDB_CAMERA_HDF5_CLIP_NEAR,
                                RDB_CAMERA_HDF5_CLIP_FAR,
                                RDB_CAMERA_HDF5_FOCAL_X,
                                RDB_CAMERA_HDF5_FOCAL_Y,
                                RDB_CAMERA_HDF5_PRINCIPAL_X,
                                RDB_CAMERA_HDF5_PRINCIPAL_Y,
                                RDB_CAMERA_HDF5_SPARE1,
                                RDB_CAMERA_HDF5_NDATA};
        
        explicit Hdf5RdbCamera ();

        virtual ~Hdf5RdbCamera ();
